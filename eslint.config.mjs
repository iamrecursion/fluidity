...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      // Parts of the suite stand in for Obsidian internals that have no published types, so they
      // build objects typed as `any` deliberately. These rules exist to stop `any` spreading
      // through the plugin, and still do so in src/.
